...
const QUESTIONS = [
    {
        question: "క్రింది వాటిలో 'వికాసం' (Development) యొక్క సరైన లక్షణం ఏది?",
        options: [
            "కేవలం శరీర పరిమాణంలో పెరుగుదల మాత్రమే",
            "జననం నుండి మరణం వరకు కొనసాగే గుణాత్మక మరియు పరిమాణాత్మక మార్పుల ప్రక్రియ",
            "బరువు పెరగడం మాత్రమే",
            "వయస్సు పెరగడమే వికాసం"
        ],
        correct: 1,
        explanation: "వికాసం అనేది జీవితాంతం కొనసాగే నిరంతర ప్రక్రియ. ఇందులో శారీరక, మానసిక, సామాజిక, భావోద్వేగ పరమైన గుణాత్మక మరియు పరిమాణాత్మక మార్పులు ఉంటాయి."
    },
    {
        question: "శిశువులో తల నుండి పాదాల వైపు వికాసం జరిగే సూత్రాన్ని ఏమంటారు?",
        options: [
            "సమీపం నుండి దూరం (Proximo-distal)",
            "సామాన్యం నుండి ప్రత్యేకం",
            "తల నుండి పాదాల వరకు (Cephalo-caudal)",
            "వ్యక్తిగత భేదాల సూత్రం"
        ],
        correct: 2,
        explanation: "Cephalo-caudal సూత్రం ప్రకారం శిశువులో వికాసం ముందుగా తల భాగంలో ప్రారంభమై తరువాత శరీరం క్రింది భాగాలకు విస్తరిస్తుంది."
    },
    {
        question: "ప్రయత్నం - తప్పిదం (Trial and Error) అభ్యాస సిద్ధాంతాన్ని ప్రతిపాదించిన మనోవిజ్ఞాన శాస్త్రవేత్త ఎవరు?",
        options: [
            "బి.ఎఫ్. స్కిన్నర్",
        ...
        correct: 1,
        explanation: "థార్న్‌డైక్ ప్రయత్నం-తప్పిదం సిద్ధాంతాన్ని ప్రతిపాదించాడు. సరైన ప్రతిస్పందన పునరావృతం ద్వారా బలపడుతుందని ఆయన వివరించాడు."
    },
    {
        question: "క్రింది వాటిలో నిర్మాణవాదం (Constructivism) భావనకు అనుకూలమైనది ఏది?",
        options: [
            "ఉపాధ్యాయుడు మాత్రమే జ్ఞానానికి మూలం",
            "విద్యార్థి తన అనుభవాల ద్వారా జ్ఞానాన్ని నిర్మించుకుంటాడు",
            "పాఠాన్ని కంఠస్థం చేయడం ప్రధాన లక్ష్యం",
            "శిక్ష ద్వారా అభ్యాసం మెరుగుపడుతుంది"
        ],
        correct: 1,
        explanation: "నిర్మాణవాదం ప్రకారం విద్యార్థి తన అనుభవాలు, పరస్పర చర్యలు మరియు ఆలోచనల ద్వారా స్వయంగా జ్ఞానాన్ని నిర్మించుకుంటాడు."
    },
    {
        question: "మాస్లో అవసరాల క్రమశ్రేణి సిద్ధాంతం ప్రకారం అత్యున్నత అవసరం ఏది?",
        options: [
            "భద్రత అవసరాలు",
            "సామాజిక అవసరాలు",
            "ఆత్మసాక్షాత్కారం (Self-actualization)",
            "గౌరవ అవసరాలు"
        ],
        correct: 2,
        explanation: "మాస్లో సిద్ధాంతంలో అత్యున్నత స్థాయి ఆత్మసాక్షాత్కారం. వ్యక్తి తన సంపూర్ణ సామర్థ్యాన్ని అభివృద్ధి చేసుకోవడం దీనికి ముఖ్య ఉద్దేశ్యం."
    },
    {
